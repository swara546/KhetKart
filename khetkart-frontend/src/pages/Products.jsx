...
function categoryEmoji(cat) {
  const map = { Seeds: "🌱", Fertilizers: "🧪", Tools: "⛏️", Pesticides: "🛡️" };
  return map[cat] || "📦";
}
          ...
          <div className="grid grid-cols-2 gap-3 mb-5 text-sm">
            ...
            {product.seller && (
              <div className="bg-gray-50 rounded-xl p-3">
                ...
                <p className="font-semibold text-gray-700">{product.seller}</p>
              </div>
            )}
          </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-green-800 to-emerald-700 text-white px-6 py-10">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-extrabold mb-1">Products 🌾</h1>
