...
const categories = [
  { path: "/products?cat=seeds", label: "Seeds" },
  { path: "/products?cat=fertilizers", label: "Fertilizers" },
  { path: "/products?cat=tools", label: "Tools" },
  { path: "/products?cat=pesticides", label: "Pesticides" },
];
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-1">
          ...
          <p className="mt-3 text-sm text-green-300 leading-relaxed">
            India's trusted marketplace for seeds, fertilizers, and farming tools — delivered to your doorstep.
          </p>
        ...
        {/* Quick Links */}
        <div>
          <h3 className="font-bold text-sm uppercase tracking-widest text-green-400 mb-4">
            Quick Links
          </h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-green-200 mb-6">
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:support@khetkart.com" className="hover:text-yellow-400 transition">
                support@khetkart.com
              </a>
            </li>
            <li className="flex items-center gap-2">
              <MdPhone className="text-green-400 shrink-0" size={16} />
              <a href="tel:+911234567890" className="hover:text-yellow-400 transition">
                +91 1234567890
              </a>
            </li>
          ...
          {/* Newsletter */}
          <h3 className="font-bold text-sm uppercase tracking-widest text-green-400 mb-3">
            Get Offers
          </h3>
          {subscribed ? (
